...
function rotationZ(angle: number, vector: [number, number, number]) {
...
function rotationY(angle: number, vector: [number, number, number]) {
...
function rotationX(angle: number, vector: [number, number, number]) {
  const x = vector[1];
