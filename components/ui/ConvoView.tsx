    ...
    return (
        <div>
            ...
            {appMode == 2 ? <div><Image alt="profile" src={ProfileImg}></Image>
                <div className="p-4" style={{ height: "51vh" }}><h1 className="text-xl">Profile and Settings</h1><h2 className="text-lg">Calibration</h2><Button className="text-base" onClick={Record?.recentre} label="Recentre Device"></Button><h2 className="text-lg">Compass Realignment</h2><Button className="text-base" onClick={CompassCap?.Recalibrate} label="Set Current Direction as North"></Button></div></div> : <div></div>}
