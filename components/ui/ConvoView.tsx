...
import cta from '../../public/View_paper.png'
    ...
    return (
        <div>
            ...
            {appMode == 2 ? <div><Image alt="profile" src={ProfileImg}></Image>
                <div className="p-4" style={{ height: "41vh" }}><h1 className="text-xl">Profile and Settings</h1><h2 className="text-lg">Calibration</h2><Button className="text-base" onClick={Record?.recentre} label="Recentre Device"></Button><h2 className="text-lg">Compass Realignment</h2><Button className="text-base" onClick={CompassCap?.Recalibrate} label="Set Current Direction as North"></Button><div style={{ display: "flex", justifyContent: 'space-evenly', textAlign: 'center', width: '448px', padding: '6rem' }}><Image alt="view_paper" src={cta} /></div></div></div> : <div></div>}
